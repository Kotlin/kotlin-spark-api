 ...
 * =LICENSEEND=
 */
@file:Suppress("DEPRECATION", "unused", "unchecked")
...
open class UserDefinedFunctionVararg<T, R>(
     ...
     */
    operator fun <DsType> invoke(vararg params: TypedColumn<DsType, T>): TypedColumn<DsType, R> = udf.apply(*params).`as`(encoder) as TypedColumn<DsType, R>
