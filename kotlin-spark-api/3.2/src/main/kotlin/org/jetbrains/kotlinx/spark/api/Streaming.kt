...
//        )
//        .map {
//            c(it._1, c(it._2._1, it._2._2.getOrNull()))
//        }
//
///**
// * Return a new DStream by applying 'left outer join' between RDDs of `this` DStream and
...
//        )
//        .map {
//            c(it._1, c(it._2._1.getOrNull(), it._2._2))
//        }
//
///**
// * Return a new DStream by applying 'right outer join' between RDDs of `this` DStream and
...
//        )
//        .map {
//            c(it._1, c(it._2._1.getOrNull(), it._2._2.getOrNull()))
//        }
//
///**
// * Return a new DStream by applying 'full outer join' between RDDs of `this` DStream and
...
//        )
//        .map {
//            Pair(it._1, Pair(it._2._1, it._2._2.getOrNull()))
//        }
//
///**
// * Return a new DStream by applying 'left outer join' between RDDs of `this` DStream and
...
//        )
//        .map {
//            Pair(it._1, Pair(it._2._1.getOrNull(), it._2._2))
//        }
//
///**
// * Return a new DStream by applying 'right outer join' between RDDs of `this` DStream and
...
//        )
//        .map {
//            Pair(it._1, Pair(it._2._1.getOrNull(), it._2._2.getOrNull()))
//        }
//
///**
// * Return a new DStream by applying 'full outer join' between RDDs of `this` DStream and
