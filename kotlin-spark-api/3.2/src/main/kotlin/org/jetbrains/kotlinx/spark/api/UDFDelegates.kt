 ...
 * ```
 */
inline fun <reified T1, reified R> UDFRegistration.register(noinline func: (T1) -> R): UDFWrapperBuilderDelegate<UDFWrapper1> =
 ...
 * ```
 */
inline fun <reified T1, reified T2, reified R> UDFRegistration.register(noinline func: (T1, T2) -> R): UDFWrapperBuilderDelegate<UDFWrapper2> =
    UDFWrapperBuilderDelegate { name -> register(name, func) }
 ...
 * ```
 */
inline fun <reified T1, reified T2, reified T3, reified R> UDFRegistration.register(noinline func: (T1, T2, T3) -> R): UDFWrapperBuilderDelegate<UDFWrapper3> =
    UDFWrapperBuilderDelegate { name -> register(name, func) }
 ...
 * ```
 */
inline fun <reified T1, reified T2, reified T3, reified T4, reified R> UDFRegistration.register(noinline func: (T1, T2, T3, T4) -> R): UDFWrapperBuilderDelegate<UDFWrapper4> =
    UDFWrapperBuilderDelegate { name -> register(name, func) }
 ...
 * ```
 */
inline fun <reified T1, reified T2, reified T3, reified T4, reified T5, reified R> UDFRegistration.register(noinline func: (T1, T2, T3, T4, T5) -> R): UDFWrapperBuilderDelegate<UDFWrapper5> =
    UDFWrapperBuilderDelegate { name -> register(name, func) }
...
): UDFWrapperBuilderDelegate<UDFWrapper6> = UDFWrapperBuilderDelegate { name -> register(name, func) }
...
): UDFWrapperBuilderDelegate<UDFWrapper7> = UDFWrapperBuilderDelegate { name -> register(name, func) }
...
): UDFWrapperBuilderDelegate<UDFWrapper8> = UDFWrapperBuilderDelegate { name -> register(name, func) }
...
): UDFWrapperBuilderDelegate<UDFWrapper9> = UDFWrapperBuilderDelegate { name -> register(name, func) }
...
): UDFWrapperBuilderDelegate<UDFWrapper10> = UDFWrapperBuilderDelegate { name -> register(name, func) }
...
): UDFWrapperBuilderDelegate<UDFWrapper11> = UDFWrapperBuilderDelegate { name -> register(name, func) }
...
): UDFWrapperBuilderDelegate<UDFWrapper12> = UDFWrapperBuilderDelegate { name -> register(name, func) }
...
): UDFWrapperBuilderDelegate<UDFWrapper13> = UDFWrapperBuilderDelegate { name -> register(name, func) }
...
): UDFWrapperBuilderDelegate<UDFWrapper14> = UDFWrapperBuilderDelegate { name -> register(name, func) }
...
): UDFWrapperBuilderDelegate<UDFWrapper15> = UDFWrapperBuilderDelegate { name -> register(name, func) }
...
): UDFWrapperBuilderDelegate<UDFWrapper16> = UDFWrapperBuilderDelegate { name -> register(name, func) }
...
): UDFWrapperBuilderDelegate<UDFWrapper17> = UDFWrapperBuilderDelegate { name -> register(name, func) }
...
): UDFWrapperBuilderDelegate<UDFWrapper18> = UDFWrapperBuilderDelegate { name -> register(name, func) }
...
): UDFWrapperBuilderDelegate<UDFWrapper19> = UDFWrapperBuilderDelegate { name -> register(name, func) }
...
): UDFWrapperBuilderDelegate<UDFWrapper20> = UDFWrapperBuilderDelegate { name -> register(name, func) }
...
): UDFWrapperBuilderDelegate<UDFWrapper21> = UDFWrapperBuilderDelegate { name -> register(name, func) }
...
): UDFWrapperBuilderDelegate<UDFWrapper22> = UDFWrapperBuilderDelegate { name -> register(name, func) }
